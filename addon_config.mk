...
meta:
	ADDON_NAME = ofxOpenCv2
	ADDON_DESCRIPTION = Addon for using latest OpenCV
	ADDON_AUTHOR = Antoine Villeret
	ADDON_TAGS = "computer vision" "opencv" "image processing"
	ADDON_URL = https://github.com/avilleret/ofxOpenCv2
...
common:
	...
	# addon
	ADDON_CFLAGS = -I/usr/local/Cellar/opencv/2.4.12_2/include/opencv -I/usr/local/Cellar/opencv/2.4.12_2/include
	
	# any special flag that should be passed to the linker when using this
	# addon, also used for system libraries with -lname
	ADDON_LDFLAGS = -L/usr/local/Cellar/opencv/2.4.12_2/lib -lopencv_calib3d -lopencv_contrib -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_gpu -lopencv_highgui -lopencv_imgproc -lopencv_legacy -lopencv_ml -lopencv_nonfree -lopencv_objdetect -lopencv_ocl -lopencv_photo -lopencv_stitching -lopencv_superres -lopencv_ts -lopencv_video -lopencv_videostab
